...
def test_phone_number_formatting(config_manager):
...
def test_address_formatting(config_manager):
...
def test_name_case_formatting(config_manager):
...
def test_special_characters_handling(config_manager):
